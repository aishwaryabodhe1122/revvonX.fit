...
import { AiOutlineUser, AiOutlineMail, AiOutlinePhone, AiOutlineWhatsApp, AiOutlineGlobal } from 'react-icons/ai';
export default function ContactPage() {
  ...
  return (<Layout title="Contact"><div className="page-gradient"><section className="section"><div className="container"><div className="row g-4">
    ...
    <div className="col-lg-6">
      ...
      </div></form>{sent === 'ok' && <div className="alert alert-success mt-3">Thanks! Your message has been sent.</div>}{sent === 'error' && <div className="alert alert-danger mt-3">Something went wrong. Please try again.</div>}</div>
    ...
    <div className="col-lg-6">
      ...
      <div className="p-4 mx-5"><ul className="list-unstyled mb-0">
        ...
        <li className="mb-3 d-flex align-items-start"><AiOutlineMail style={{color: '#d4af37', marginRight: '12px', marginTop: '2px', fontSize: '20px', flexShrink: 0}} /><span><strong>Email:</strong> coach@RevvonX.Fit.co</span></li>
